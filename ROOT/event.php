            ...
            <div class="row">
                <div class="col-8 p-3 d-flex flex-column">
                    ...
                    <div class="w-75">
                        ...
                        <p>Join us for a look into the new age of art and get a first-time look at some of South Africa's upcoming contemporary artists.</p>
                ...
                <div class="col-4">
                    ...
                    <div class="d-flex flex-column p-3">
                        <div class="p-1 mt-2 review-box">
                            <p class="h5">My Favourite Event</p>
                            <div class="d-flex justify-content-between">
                                <p>@girlwiththepearlearring</p>
                                <p><i class="fa fa-star fa-xl"></i><i class="fa fa-star fa-xl"></i><i class="fa fa-star fa-xl"></i><i class="fa fa-star fa-xl"></i><i class="fa fa-star fa-xl"></i></p>
                            </div>
                            <p>This has got to be my favourite event thus far. Super Reccommend!!!</p>
                        </div>
                    </div>
                    <hr>
                    <div class="">
